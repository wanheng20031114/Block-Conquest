...
const KINDS: Array[String] = ["swordsman", "shield_guard", "spearman", "archer", "crossbowman", "knight", "war_elephant", "light_cavalry", "catapult", "cannon", "heavy_cannon", "triple_cannon", "engineer", "priest", "farmer", "headquarters", "gold_vein", "defense_tower", "barracks", "factory", "academy"]
