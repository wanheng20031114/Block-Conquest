...
@export_enum("swordsman", "shield_guard", "spearman", "archer", "crossbowman", "musketeer", "knight", "war_elephant", "light_cavalry", "catapult", "cannon", "heavy_cannon", "triple_cannon", "engineer", "priest", "farmer", "zombie", "zombie_archer", "zombie_musketeer", "zombie_crossbowman", "zombie_pitchfork", "zombie_axe", "zombie_miner", "zombie_bell", "zombie_door") var kind: String = "swordsman"
