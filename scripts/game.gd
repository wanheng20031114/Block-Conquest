...
const UNIT_TYPES := ["swordsman", "shield_guard", "spearman", "archer", "crossbowman", "musketeer", "knight", "war_elephant", "light_cavalry", "catapult", "cannon", "heavy_cannon", "triple_cannon", "engineer", "priest", "farmer"]
const UNIT_NAMES := {"swordsman": "剑士", "shield_guard": "盾卫", "spearman": "长矛兵", "archer": "弓箭手", "crossbowman": "弩手", "musketeer": "火枪手", "knight": "骑士", "war_elephant": "战象", "light_cavalry": "轻骑兵", "catapult": "投石车", "cannon": "加农炮", "heavy_cannon": "重型火炮", "triple_cannon": "三管短炮", "engineer": "工程兵", "priest": "牧师", "farmer": "农民"}
const MAX_ARMY: int = 160
const EFFECT_SOUNDS: Dictionary = {"hit": &"sword_hit", "wood_hit": &"wood_hit", "stone_chip": &"stone_chip", "arrow_hit": &"arrow_hit", "bullet_hit": &"arrow_hit", "musket_muzzle": &"musket_shot", "muzzle": &"cannon_shot", "explosion": &"explosion", "stone_hit": &"stone_hit", "collapse": &"collapse"}
...
func find_recruit_position(kind: String, building: BattleBuilding = null) -> Vector3:
	...
	shape.radius = definition.radius * 0.85 + 0.05
