...
const EVENTS: Dictionary = {
	# Dedicated dry powder crack and pressure body; the shared pool bounds volleys.
	"musket_shot": {"streams": [preload("res://assets/audio/musket_shot_01.wav"), preload("res://assets/audio/musket_shot_02.wav")], "gain_db": -2.0, "bus": &"Combat", "priority": 3, "gap_ms": 110, "limit": 3},
