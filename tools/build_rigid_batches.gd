...
const VARIANT_KINDS: PackedStringArray = ["musketeer_advanced", "swordsman_advanced", "shield_guard_advanced", "spearman_advanced", "archer_advanced", "crossbowman_advanced", "knight_advanced", "light_cavalry_advanced", "war_elephant_advanced"]
