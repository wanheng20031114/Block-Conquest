...
const KINDS: PackedStringArray = ["swordsman", "archer", "knight", "catapult", "cannon", "farmer", "spearman", "shield_guard", "war_elephant", "light_cavalry", "engineer", "priest", "heavy_cannon", "triple_cannon", "crossbowman"]
