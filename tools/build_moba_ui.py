...
def hud_scene():
    ...
    s.label('OurBase','Layout/Top','我方大本营  2200',(267,9,330,23),17)
    ...
    s.label('EnemyBase','Layout/Top','敌方大本营  2200',(886,9,290,23),17)
    ...
    s.node('MapPanel','Control',c,(24,16,294,249),'mouse_filter = 2')
    m = c+'/MapPanel'
    s.icon('ForestIcon',m,'forest',(0,3,24,30))
    s.label('MapTitle',m,'林地防线',(36,1,195,32),21)
    ...
    s.node('HeroPanel','Control',c,(-324,15,300,250),'mouse_filter = 2',anchor=(1,0))
    p = c+'/HeroPanel'
    ...
    s.panel('Dialog','Layout/Modal',(-210,-190,420,380),'Panel',anchor=(.5,.5))
    ...
    for index,(name,title) in enumerate([('Resume','继续对局'),('Restart','重新开始'),('Settings','设置'),('Back','返回主菜单')]):
        s.node(name,'Button','Layout/Modal/Dialog',(30,140+index*54,360,43),props=f'text = "{title}"\nfocus_mode = 0')
