...
后续的完整作战底栏、森林重制与可生产守军版本见 [本次验证与实战记录](../report/rogue-forest-refresh.md)。下文的原始战斗耗时属于固定敌军的旧版基线，不代表更新后的难度。

编队框选、兵种合并、双击转移、两轮即时招募、战利品界面及版本2存档迁移的最新验证见 [编队与招募更新](../report/rogue-recruitment.md)。下列最初版本的券库存及取消规则已由即时招募替代，历史检查数量保留作追溯。
...
基线版本的围剿资源为 1800 HP 基地、双甲 3、基础攻击 24、150 秒坚守、同时活敌上限 24；7 波在 10/30/50/70/90/110/130 秒生成 4/5/6/7/8/9/9 名敌军。旧前哨为 5 塔 3 营，普通固定 16 名敌军、紧急固定 20 名；塔攻击 9 是基础值，仍保留原单位类别附伤，不能当作实际每击扣血。新版前哨仅初始人数相同，之后兵营会生产援军。
