...
原模式运行库由 81 份保留原样的 CC0 音源和项目自制数字合成层构成，生成 22 类、56 个 WAV 变体。积木战争另有下文说明的 21 类、36 个专用 WAV。所有第三方素材均来自下列作者发布页面，下载日期为 2026-09-08；没有使用 Sonniss、付费素材、要求单独授权的录音或背景音乐。
