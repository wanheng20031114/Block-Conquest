...
盾卫、战象v4已通过用户验收。轻骑兵v2已完成腿脚与鞍毯贴合修订，等待验收：70金币、90生命、近甲1/远甲3、7近战、对弓手+2、6.8移速、20视野、7秒训练。布帽、上衣和鞍毯提供队伍色，裸露马身与轻装骑手区别于骑士，详见 [轻骑兵制作与验证](report/light-cavalry-2026-09-12.md)。完整制作顺序见 [七单位计划](docs/unit-expansion-plan.md)，当前阶段见 [验收记录](docs/unit-expansion-status.md)。工程兵尚未开始；工程兵、牧师的计划移速同为3.5。
